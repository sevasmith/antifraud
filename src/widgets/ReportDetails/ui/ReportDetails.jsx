                ...
                <div className="rd-data-column">
                    <div className="rd-card">
                        ...
                        <ul className="key-value-list">
                            ...
                            <li><span className="key">CVV Response</span> <span className="value text-green">{alert?.cvvResponse}</span></li>
                            <li><span className="key">AVS Response</span> <span className="value text-green">{alert?.avsResponse}</span></li>
                            <li><span className="key">Number</span> <span className="value">{alert?.cardNumber}</span></li>
                            <li><span className="key">Bank</span> <span className="value">{alert?.bankName}</span></li>
                        </ul>
                    </div>
                    ...
                    <div className="rd-card">
                        ...
                        <ul className="key-value-list">
                            <li><span className="key">Number</span> <span className="value">{alert?.accountNumber}</span></li>
                            <li><span className="key">Order Amount</span> <span className="value">{alert?.amount}</span></li>
                            <li><span className="key">Creation Date</span> <span className="value">{alert?.date}</span></li>
                            <li><span className="key">Update Date</span> <span className="value">{alert?.date}</span></li>
                            <li><span className="key">Last Order Ext. ID</span> <span className="value">{alert?.lastOrderId}</span></li>
                        </ul>
                    </div>
                </div>
